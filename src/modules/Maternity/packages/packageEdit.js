...
class PackageEdit extends Component {
  ...
  _handleSubmit = (e) => {
    ...
    form.validateFields((err, values) => {
      const { serviceBeanList, ...restvalues } = values
      if (!err) {
        dispatch(actions.edit({
          ...restvalues,
          serviceList: serviceBeanList && serviceBeanList.length > 0 ? serviceBeanList.map((item) => item.id) : '',
  ...
  _getServiceParams = () => {
    ...
    return {
      ...
      selectedList: form.getFieldValue('serviceBeanList'),
          ...
          <Row>
            ...
            <Col span={10}>
              ...
              >
                {getFieldDecorator('comboPrice', {
                  ...
                  initialValue: detail.comboPrice
                })(
                  <InputNumber
                    min={0}
                    step={0.01}
            ...
            <Col span={10}>
              <FormItem
                ...
                {...formItemLayout}
              >
                {getFieldDecorator('serviceBeanList', {
                  rules: [{
                    required: true,
                    message: '请选择服务项目',
                  }],
                  initialValue: detail.serviceBeanList,
                })(
                  <ModalSelectInput
            ...
            <Col span={20}>
              ...
              >
                {getFieldDecorator('environService', {
                  ...
                  initialValue: detail.environService
                })(
                  <TextArea
                    placeholder='请输入环境服务'
                    maxLength={500}
...
export default connect(mapStateToProps, mapDispatchToProps)(Form.create()(PackageEdit))
