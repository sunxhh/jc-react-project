...
class SelectRoomModal extends Component {
  _columns = [
    {
      title: '序号',
      dataIndex: 'rowNo',
  ...
  _onCancel = () => {
    this.props.dispatch(actions.showRoomModalAction(false))
  }
...
export default Form.create()(SelectRoomModal)
