...
class BillOrderDetail extends Component {
  ...
  componentDidMount() {
    ...
    if (match.params && match.params.orderNo) {
      dispatch(Module.actions.getBillOrderDetail({ orderNo: match.params.orderNo }))
    }
  }
...
export default connect(['common.showListSpin', 'retail.closeBill'], mapStateToProps)(Form.create()(BillOrderDetail))
