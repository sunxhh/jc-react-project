...
class CategoryTwo extends Component {
  ...
  _willUnmountQueryArgData = () => {
    const { dispatch } = this.props
    dispatch(Module.actions.setCategoryTwoQueryPar({
      orgCode: '',
      orderStartTime: '',
      orderEndTime: '',
    }))
  ...
  _setQueryPar = () => {
    ...
    dispatch(Module.actions.setCategoryTwoQueryPar(arg))
  }
  ...
  // 导出操作
  _handleExport = () => {
    if (isEmpty(this.props.rankCategoryList)) {
              ...
              >
                {getFieldDecorator('orgCode', {
                  ...
                  <Select
                    ...
                    getPopupContainer={() => document.getElementById('rowAreaTwo')}
                  >
              ...
              >
                {getFieldDecorator('orderTime', {
                  ...
                  <RangePicker
                    ...
                    getCalendarContainer={() => document.getElementById('rowAreaTwo')}
                  />
                )}
              </FormItem>
            </Col>
...
export default connect(['common.auths', 'common.showListSpin', 'retail.report'], mapStateToProps)(Form.create()(CategoryTwo))
