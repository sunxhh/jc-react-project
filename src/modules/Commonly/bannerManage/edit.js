...
class Edit extends Component {
  ...
  componentDidMount() {
    ...
    dispatch(actions.getBannerDetail({ id: this.props.match.params.id }))
  }

  componentWillReceiveProps(nextProps) {
    if (this.props.detailBanner !== nextProps.detailBanner) {
      this.setState({
        bannerImage: [{ uid: 1, url: nextProps.detailBanner.image }]
      })
    }
  }
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        dispatch(actions.editBanner(reqBean))
      }
    })
  }

  render() {
    const { orgList, token, detailBanner } = this.props
            ...
            <Col span={16}>
              ...
              >
                ...
                >
                  {getFieldDecorator('orgId', {
                    ...
                    initialValue: detailBanner.orgId
                  })(
                    <Select
                      placeholder='请选择所属机构'
              ...
              >
                {getFieldDecorator('name', {
                  ...
                  initialValue: detailBanner.name
                })(
                  <Input
                    placeholder='请输入名称'
                  />
              ...
              >
                {getFieldDecorator('sort', {
                  ...
                  initialValue: detailBanner.sort
                })(
                  <Input
                    placeholder='请输入排序序号'
                  />
              ...
              >
                ...
                >
                  {getFieldDecorator('bannerTime', {
                    ...
                    initialValue: [
                      detailBanner.startTime ? moment(detailBanner.startTime) : '',
                      detailBanner.endTime ? moment(detailBanner.endTime) : ''
                    ],
                  })(
                    <RangePicker
...
const mapStateToProps = (state) => {
  return {
    ...
    detailBanner: state.banner.detailBanner,
